...
static constexpr array<SimpleFontKeyMap, 37> key_map = {{
    ...
    {Keys::Z, &Z},   {Keys::_1, &_1},       {Keys::_2, &_2}, {Keys::_3, &_3}, {Keys::_4, &_4},
    {Keys::_5, &_5}, {Keys::_6, &_6},       {Keys::_7, &_7}, {Keys::_8, &_8}, {Keys::_9, &_9},
    {Keys::_0, &_0}, {Keys::SPACE, &SPACE},
}};
